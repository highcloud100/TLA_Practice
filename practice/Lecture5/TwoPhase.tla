...
TMRcvPrepared(r) ==
  ...
  \* 위의 두 부분은 enabling conditions 이다.  
  \* msg가 삭제되지 않기에 계속 true이다. 만약 같은 r이 주어진 경우에는 cup 연산을 사용하기에 tmPrepared는 변화가 없게 된다. 
...
TCConsistent ==
    \/ \E r1 \in RM : rmState[r1] = "aborted"
    => ~ \E r2 \in RM : rmState[r2] = "committed"
